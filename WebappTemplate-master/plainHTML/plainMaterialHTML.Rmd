...
params:
  output_filename: "plain2BSHTML.html"
---
...
此模版產生一個沒有使用任何外掛framework及js library的html檔。
...
<object id="myObject" data="assets/party.svg" type="image/svg+xml" width="100%"></object>
...
file.edit("external/in_header/header.html")
```
